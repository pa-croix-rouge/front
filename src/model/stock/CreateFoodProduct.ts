export class CreateFoodProduct {
    ...
    constructor(name: string, quantity: number, measurementUnit: string, foodConservation: string, expirationDate: Date, optimalConsumptionDate: Date, price: number, storageId: string, amount: number) {
        this.name = name;
